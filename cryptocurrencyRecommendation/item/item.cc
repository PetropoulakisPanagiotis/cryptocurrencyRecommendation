...
void Item::clearComponents(void){    

    int componentPos;

    for(componentPos = 0; componentPos < this->dim; componentPos++)
        this->components[componentPos] = 0;
}

/* Sum given component with i-component */
void Item::sumComponent(double newComponent, int index, errorCode& status){    
    status = SUCCESS;
...
/* Sum given component with i-component */
void Item::divComponent(double newComponent, int index, errorCode& status){    
    status = SUCCESS;
